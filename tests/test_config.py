...
def test_assistant_enabled_defaults_to_true(tmp_yaml):
    path = tmp_yaml("""\
        assistants:
          a:
            adapter: claude-code
    ...
    """)
    cfg = load_config(path)
    assert cfg.assistants["a"].enabled is True


def test_assistant_enabled_false_parsed(tmp_yaml):
    path = tmp_yaml("""\
        assistants:
          a:
            adapter: claude-code
    ...
    """)
    cfg = load_config(path)
    assert cfg.assistants["a"].enabled is False


def test_task_enabled_defaults_to_true(tmp_yaml):
    path = tmp_yaml("""\
        assistants:
          a:
            adapter: claude-code
...
def test_task_enabled_false_parsed(tmp_yaml):
    path = tmp_yaml("""\
        assistants:
          a:
            adapter: claude-code
    ...
    cfg = load_config(path)
    assert cfg.tasks[0].enabled is True
    assert cfg.tasks[1].enabled is False
